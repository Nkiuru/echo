...
const getUserByIdWEmail = (id) => {
  return new Promise((resolve, reject) => {
    connection.query(
      `SELECT u.userId, u.username, u.displayName, country.countryCode, u.city, u.bio, u.profileImageId, u.email, u.isAdmin, 
...
const getAudioPost = (entityId) => {
  return new Promise((resolve, reject) => {
    connection.execute(
      ...
      u.displayName, u.username, uf.fileName as userImg FROM entity e, audioPost ap, song, upload, genre, band, 
